...
import urllib
# # result_path = 'data/result_sored_line.txt'  # 爬取数据文件保存路径
# # 百度地图提供的api服务网址
...
#
# result_path = 'result_soredline.txt'  # 爬取数据文件保存路径
#
...
#
hotel_list=[]
line_data1 = csv.reader(open("酒店——信息.csv", 'r', encoding='utf-8'))  # 读取原始文件数据
...
for i in range(0,len(hotel_list)):
    num=0
    sum1=0
    line_data2 = csv.reader(open("sort_line_sum1.csv", 'r', encoding='utf-8'))  # 读取原始文件数据
...
# print(a)
# b=[]
# ine_data2 = csv.reader(open("赛点信息.csv", 'r', encoding='utf-8'))  # 读取原始文件数据
# for f in ine_data2:
#     b.append(f[2])
# print(b)
#
