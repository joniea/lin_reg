...
origin_path = 'data/star hotel list.csv'  # 原始数据文件路径
new_path = 'data/酒店——信息.txt'  # 爬取数据文件保存路径
...
for addr in machine_data:  # 循环爬取每一条数据
    ...
    with open("data/酒店——信息.csv", 'a', newline='',encoding='utf-8') as t:  # numline是来控制空的行数的
