...
AK = ['5zi1GV91StUx1FnhNRW2BpDOrkLi0hFd']


# 原数据文件格式csv： 起点纬度 + 起点经度 + 索引 + 终点纬度 + 终点经度
origin_path_jiudian = '3star酒店信息.csv'  # 原始数据文件路径
            ...
            for point in address_point:
                ...
                if (akn1 < len(AK)) and (akn2 < len(AK)):  # 配额是否够
                    ...
                    try:
                        ...
                        with open("3star_sort_line_sum.csv", 'a', newline='', encoding='utf-8') as t:  # numline是来控制空的行数的
